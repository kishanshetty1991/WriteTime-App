...
import com.example.writetime.activities.PdfListAdminActivity;
import com.example.writetime.filters.FilterCategory;
import com.example.writetime.Models.ModelCategory;
import com.example.writetime.databinding.RowCategoryBinding;
...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.HolderCategory> implements Filterable {
    ...
    private void deleteCategory(ModelCategory model, HolderCategory holder) {
        ...
        //FirebaseDB > category > categoryID
        String id =model.getId();
