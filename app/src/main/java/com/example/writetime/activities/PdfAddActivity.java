...
import com.example.writetime.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(title)){
            ...
            Toast.makeText(this, "Pick Pdf by clicking on the top-right Attach Icon", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    private void uploadedPdfInfoToDb(String uploadedPdfUrl, long timestamp) {
        //Upload Pdf to Firebase Database
        Log.d(TAG, "uploadPdfToStorage: uploading Pdf info to Firebase Database...");
        progressDialog.setMessage("Uploading pdf info...");
        String uid = firebaseAuth.getUid();
        //setup data to upload

        //setup data to upload, also add view count, download count ehile adding pdf/book
    ...
    private void categoryPickDialog() {
        //Get Categories from database using LoadCategories() above
