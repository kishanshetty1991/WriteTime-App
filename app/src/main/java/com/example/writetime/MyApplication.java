package com.example.writetime;

import static com.example.writetime.Constants.MAX_BYTES_PDF;
...
import com.example.writetime.adapters.AdapterPdfAdmin;
...
public class MyApplication extends Application {
    ...
    public static void deleteBook(Context context, String bookID, String bookUrl, String bookTitle) {
        ...
        progressDialog.setMessage("Deleting "+bookTitle+" ...."); //deleting book ABC
        progressDialog.show();
                        ...
                        pdfView.fromBytes(bytes)
                                ...
                                .onLoad(new OnLoadCompleteListener() {
                                    ...
                                    public void loadComplete(int nbPages) {
                                        ...
                                        if(pagesTv!=null){
                                            pagesTv.setText(""+nbPages); //concatenate with double quotes bcoz cant set int in textview
                                        }
...
//        1.Get book views count
    ...
    public static void downloadBook(Context context, String bookID, String bookTitle, String bookUrl){
        ...
        ProgressDialog progressDialog = new ProgressDialog(context);
        progressDialog.setTitle("Please wait");
        progressDialog.setMessage("Downloading "+nameWithExtension+"...");//eg Downloading ABC.pdf
