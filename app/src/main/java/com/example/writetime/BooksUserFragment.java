...
import com.example.writetime.databinding.FragmentBooksUserBinding;
...
public class BooksUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.searchEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                //Log.d(TAG, "onTextChanged: Just before you");
                try{
                    //Log.d(TAG, "onTextChanged: I am here");
    ...
    private void laodCategorizedBooks() {
        //init list
        pdfArrayList = new ArrayList<>();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Books");
